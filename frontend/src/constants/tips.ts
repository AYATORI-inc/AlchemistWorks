...
export const TIPS: Tip[] = [
  // 合成ヒント
  { category: 'synthesis', text: '釜には素材を2つ入れると調合できるよ' },
  { category: 'synthesis', text: '作ったものも釜に入れると、もっとすごいものが作れるよ' },
  { category: 'synthesis', text: '生産個数は1〜20個。+10ボタンでまとめて増やせるよ' },
  ...
  { category: 'operation', text: '商品棚の「もどす」で在庫に戻して、もう一度調合に使えるよ' },
  { category: 'operation', text: '基本素材はいつでも工房にあるよ。買わなくて大丈夫' },
  { category: 'operation', text: 'ヘッダーからレシピブックと実績をいつでも開けるよ' },
  // 調合ペース
  { category: 'pace', text: '素早く・普通・ゆっくりで、調合中の待ち時間と結果の傾向が変わるよ' },
  ...
  { category: 'system', text: '調合・売上・陳列の数も実績の対象になるよ' },
  // 世界観
